...
const assignPermissionToRole = (roleId, permissionId) => __awaiter(void 0, void 0, void 0, function* () {
    return RolePermission_1.RolePermission.create({ roleId, permissionId });
});
