...
router.delete("/:id", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRole)([roles_1.Roles.MANAGER, roles_1.Roles.ADMINISTRATIVE]), weeklySummaryController.deleteWeeklySummary);
