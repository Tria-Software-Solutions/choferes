...
router.delete("/:id", authMiddleware_1.authenticateToken, (0, roleMiddleware_1.authorizeRole)(["Super Administrador, Administrador"]), biweeklySummaryController.deleteBiweeklySummary);
