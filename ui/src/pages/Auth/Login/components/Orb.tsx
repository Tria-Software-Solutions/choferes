...
const Orb = ({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const hoverVal = program.uniforms.hover.value;
      program.uniforms.hover.value += (effectiveHover - hoverVal) * 0.1;
  ...
  return <Box ref={containerRef} sx={{ position: "fixed", inset: 0, zIndex: 0 }} />;
};
